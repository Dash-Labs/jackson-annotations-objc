...
typedef NS_ENUM(NSUInteger, ComFasterxmlJacksonAnnotationJsonInclude_Include_Enum) {
  ...
  ComFasterxmlJacksonAnnotationJsonInclude_Include_Enum_USE_DEFAULTS = 5,
};
...
@interface ComFasterxmlJacksonAnnotationJsonInclude_Value : NSObject < ComFasterxmlJacksonAnnotationJacksonAnnotationValue > {
 @public
  ComFasterxmlJacksonAnnotationJsonInclude_Include *valueInclusion_;
  ComFasterxmlJacksonAnnotationJsonInclude_Include *contentInclusion_;
}
...
J2OBJC_FIELD_SETTER(ComFasterxmlJacksonAnnotationJsonInclude_Value, valueInclusion_, ComFasterxmlJacksonAnnotationJsonInclude_Include *)
J2OBJC_FIELD_SETTER(ComFasterxmlJacksonAnnotationJsonInclude_Value, contentInclusion_, ComFasterxmlJacksonAnnotationJsonInclude_Include *)
