...
FOUNDATION_EXPORT ComFasterxmlJacksonAnnotationJsonFormat_ShapeEnum *ComFasterxmlJacksonAnnotationJsonFormat_ShapeEnum_valueOfWithNSString_(NSString *name);- (id)copyWithZone:(NSZone *)zone;
